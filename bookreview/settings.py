...
SECRET_KEY = 'django-insecure-8*td#hs)g^hno)m=4p6-wol8ab%y1n&0w1)1=l=3y(b^+!#vsq'
...
DATABASES = {
    'default': {
        ...
        'NAME': os.getenv('POSTGRES_DB', 'bookreview'),
        'USER': os.getenv('POSTGRES_USER', 'bookreview_user'),
